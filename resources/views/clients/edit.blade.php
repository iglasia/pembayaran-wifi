                ...
                <form action="{{ route('klien.update', $client->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <select class="form-control @error('internet_package_id') is-invalid @enderror selectize"
                                    ...
                                    @foreach ($internet_packages as $internet_package)
                                        <option value="{{ $internet_package->id }}"
                                            ...
                                            {{ indonesian_currency($internet_package->price) }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('nik') is-invalid @enderror" name="nik"
                                    id="nik" value="{{ old('nik', $client->nik) }}" placeholder="Masukkan NIK">
                                @error('nik')
                                    <small class="d-block font-weight-bold invalid-feedback">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="d-flex justify-content-center">
                                <img src="{{ asset($client->house_image) }}" class="img-thumbnail" id="image_preview"
                                    style="max-width: 100%; height: auto; max-height: 420px;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('longitude') is-invalid @enderror" name="longitude"
                            id="longitude" value="{{ old('longitude', $client->longitude) }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('latitude') is-invalid @enderror"
                            name="latitude" id="latitude" value="{{ old('latitude', $client->latitude) }}"
